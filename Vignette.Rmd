...
plot_CM(pval_mat_UP)
```
![Example of the plot obtained with plot_CM.](/home/laura/Regulatory Networks/Final/Publi/viñetas/plot.CM.png)
...
```
![Example of the plot obtained with plot_CM, highlighting ChIP-Seqs from EPAS1, HIF1A and ARNT.](/home/laura/Regulatory Networks/Final/Publi/viñetas/plot.CM.color.png)
...
```
![Example of the plot obtained with plot_GSEA_ES](/home/laura/Regulatory Networks/Final/Publi/viñetas/plot.ES.png)
...
```
![Example of the plot obtained with plot_GSEA_RES.](/home/laura/Regulatory Networks/Final/Publi/viñetas/plot.RES.png)
...
```
![Example of the output of plot_RES, selecting only MXI1 ChIP-Seqs that had a significant p-value.](/home/laura/Regulatory Networks/Final/Publi/viñetas/plot.RES.mxi1.png)
...
```
  ...
  iv) Load Dnase hypersensitive Sites database and generate the database with `GR2id_db`
